...
public class ReservationAcceptanceTest extends AcceptanceTestBase {
    ...
    void reservationExistCampsite() {
        ...
        String confirmationCode = previousReservation.jsonPath().getString("confirmationCode");

        ExtractableResponse<Response> response = updateReservation(reservationId, confirmationCode, afterRequest);
